...
import { id } from "date-fns/locale"; // Tambahkan locale untuk format Indonesia
...
    ? format(new Date(dueDateValue), "dd/MM/yy")
    : "dd/mm/yy";
...
            <Input
              {...form.register("title")}
              placeholder="Task Title" /* Diubah sesuai gambar */
...
            <Textarea /* Tetap menggunakan Textarea, tetapi placeholder diubah */
              {...form.register("description")}
              placeholder="Description" /* Diubah sesuai gambar */
              className="cursor-text resize-none" /* Menambahkan resize-none untuk tampilan yang lebih solid */
              rows={3} /* Mengatur jumlah baris agar tidak terlalu besar */
            />
          </div>

          {/* Priority & Due Date - Menggunakan Flexbox untuk tata letak 2 kolom */}
          <div className="flex gap-4"> 
            
            {/* Priority */}
            <div className="flex-1"> {/* flex-1 agar lebar rata */}
...
                  <SelectValue placeholder="Priority" /> {/* Menambahkan placeholder */}
                </SelectTrigger>
